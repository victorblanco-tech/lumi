...
required_paths=(
  ...
  "tools/prolink-simulator/VERSION"
  ...
  "engine/crates/lumi-remote-protocol"
  "engine/crates/lumi-remote-gateway"
  ...
  "apps/ios/VERSION"
  "apps/ios/README.md"
  "apps/ios/LumiRemote.xcodeproj"
  "apps/ios/LumiRemote"
  "apps/ios/Packages/LumiRemoteClient"
  "apps/ios/Packages/LumiRemoteFeature"
  "contracts"
  "contracts/remote/v1/manifest.json"
  "contracts/remote/v1/README.md"
  ...
  "scripts/check-product-tag.sh"
  "scripts/test-product-versioning.sh"
  ".github/workflows/product-releases.yml"
