...
tests verify loop wrapping and exclusive-master Auto Mix handoffs. The status
endpoint exposes both players, loop and Auto Mix state, per-packet counters,
profile, cadence, burst count and the last traffic error. The simulator also
